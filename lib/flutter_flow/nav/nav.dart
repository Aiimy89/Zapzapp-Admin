...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'viewOrders',
          path: '/viewOrders',
          builder: (context, params) => const ViewOrdersWidget(),
        ),
        FFRoute(
          name: 'orderDetail',
          path: '/orderDetail',
        ...
        FFRoute(
          name: 'viewProducts',
          path: '/viewProducts',
          builder: (context, params) => const ViewProductsWidget(),
        ),
        FFRoute(
          name: 'receiptPage',
          path: '/receiptPage',
        ...
        FFRoute(
          name: 'templatePage',
          path: '/templatePage',
          builder: (context, params) => TemplatePageWidget(
            productsRef: params.getParam(
              'productsRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'editTemplateDetail',
          path: '/editTemplateDetail',
          builder: (context, params) => EditTemplateDetailWidget(
        ...
        FFRoute(
          ...
          path: '/addTemplatePage',
          builder: (context, params) => AddTemplatePageWidget(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Zapzapp_Administrator.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
