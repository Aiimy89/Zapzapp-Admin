...
import 'template_page_model.dart';
export 'template_page_model.dart';
...
class _TemplatePageWidgetState extends State<TemplatePageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TemplatePageModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ProductsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final templatePageProductsRecord = snapshot.data!;
              ...
              title: Row(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Text(
                      templatePageProductsRecord.name,
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      ...
                      if (confirmDialogResponse) {
                        await templatePageProductsRecord.reference.delete();
                        context.safePop();
                      }
                    },
                  ),
                              ...
                              Padding(
                                ...
                                child: StreamBuilder<List<TemplateRecord>>(
                                  stream: queryTemplateRecord(
                                    parent:
                                        templatePageProductsRecord.reference,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemCount:
                                          listViewTemplateRecordList.length,
                                      separatorBuilder: (_, __) =>
                                          const SizedBox(height: 12.0),
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewTemplateRecord =
                                            listViewTemplateRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'CODE: ${listViewTemplateRecord.code}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .titleLarge
