...
import 'edit_size_model.dart';
export 'edit_size_model.dart';
...
class EditSizeWidget extends StatefulWidget {
  ...
  final DocumentReference? sizeRef;
...
class _EditSizeWidgetState extends State<EditSizeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditSizeModel());
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await widget.sizeRef!.update({
                                        ...mapToFirestore(
                                          {
                                            'size': FieldValue.arrayUnion(
