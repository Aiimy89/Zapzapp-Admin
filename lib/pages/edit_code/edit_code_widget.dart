...
import 'edit_code_model.dart';
export 'edit_code_model.dart';

class EditCodeWidget extends StatefulWidget {
  const EditCodeWidget({
    super.key,
    required this.codeRef,
  });

  final DocumentReference? codeRef;

  @override
  State<EditCodeWidget> createState() => _EditCodeWidgetState();
}

class _EditCodeWidgetState extends State<EditCodeWidget> {
  late EditCodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCodeModel());
