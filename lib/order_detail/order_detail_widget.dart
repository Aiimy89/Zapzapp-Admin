                      ...
                      var confirmDialogResponse = await showDialog<bool>(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: const Text(
                                    'Once deleted, the order will be removed forever. Continue?'),
                                actions: [
                                  TextButton(
                        ...
                        SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  12.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            orderDetailOrdersRecord.custName,
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  12.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            orderDetailOrdersRecord.custPhoneNo,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Manrope',
                              ...
                              if (orderDetailOrdersRecord.shipmentType ==
                                  'Postage')
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      16.0, 12.0, 16.0, 0.0),
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  12.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            '${orderDetailOrdersRecord.name} - ${orderDetailOrdersRecord.code}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  12.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            orderDetailOrdersRecord.design,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  12.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            'Order ${orderDetailOrdersRecord.orderID}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Manrope',
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FlutterFlowDropDown<String>(
                                            ...
                                            hintText:
                                                orderDetailOrdersRecord.status,
                                            icon: Icon(
                              ...
                              Padding(
                                ...
                                child: StreamBuilder<OrdersRecord>(
                                  stream: OrdersRecord.getDocument(
                                      orderDetailOrdersRecord.reference),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return const Center(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          16.0, 24.0, 16.0, 25.0),
                                      child: FFButtonWidget(
                                        onPressed: (orderDetailOrdersRecord
                                                    .status ==
                                                'Completed')
                                            ? null
                                            : () async {
                                                          ...
                                                          builder:
                                                            ...
                                                            return AlertDialog(
                                                              title: const Text(
                                                                  'Cancel Order'),
                                                              content: const Text(
                                                                  'This action will cancel the order. Confirm?'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
